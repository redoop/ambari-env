...
echo "############## SETUP BUILD_ENV start (CentOS 8) #############"
...
# 使用数组来管理要安装的包 (CentOS 8 packages)
packages=(
  apr-devel
  bison
  bzip2-devel
...
# 启动gcc 高版本 (CentOS 8 uses gcc-toolset instead of devtoolset)
...
echo "############## SETUP BUILD_ENV end (CentOS 8) #############"
